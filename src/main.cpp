...
int main(int argc, char **argv)
{
    ...
    options.add_options()("d,database", "Specify database to monitor", cxxopts::value<std::vector<std::string>>())("o,output", "Specify output JSON file", cxxopts::value<std::string>()->default_value("output.json"))("l,live", "Enable live mode", cxxopts::value<bool>()->default_value("false"))("h,help", "Print usage");
