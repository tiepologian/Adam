 ...
 * MIT License
 *
 * Copyright (c) 2018 Jan Kuri <jan@bleenco.com> - github.com/jkuri/spinners
 * 
 */
...
namespace spinners
{
  ...
  public:
    ...
    void startSpinner()
    {
      ...
      showCursor();
      if (this->writeWhenCompleted_)
        std::cout << "[*] " << text << std::endl;
    }

    void start(std::string tx, bool writeWhenCompleted)
    {
      this->text = tx;
      this->writeWhenCompleted_ = writeWhenCompleted;
